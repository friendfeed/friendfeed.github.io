...
/** Bluesky "butterfly" mark -- the exact official glyph, matching the
 *  inline share-button icon used in blog posts (e.g. FerferLeaksPage's
 *  share row), so the same icon appears everywhere on the site. */
