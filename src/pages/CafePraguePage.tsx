    ...
    <article style={{ maxWidth: 760, margin: "0 auto" }}>
      ...
      <section style={{ marginBottom: 28 }}>
        ...
        <p style={{ margin: "0 0 12px", fontSize: 13.5, lineHeight: 2, color: "var(--ff-muted)" }}>
          ...
          جایی که برای رفتنش قرار نمی‌گذاری، چون می‌دانی رفقایت آنجا هستند.
        </p>
        <p style={{ margin: "0 0 12px", fontSize: 13.5, lineHeight: 2, color: "var(--ff-muted)" }}>
          <a
          ...
          کسانی که آنجا بودند بپرسی، یک جواب تکرار می‌شود: پراگ پاتوق فرندفیدی‌ها بود.
        </p>
      </section>
      ...
      {/* Section: After */}
      <section style={{ marginBottom: 28 }}>
        <h2 style={{ fontSize: 15, margin: "0 0 10px" }}>بعد از پراگ: شیرینی‌فروشی پروگ</h2>
        <p style={{ margin: 0, fontSize: 13.5, lineHeight: 2, color: "var(--ff-muted)" }}>
          کافه پراگ رفت، اما همان فضا بعداً به شکل <strong>شیرینی‌فروشی پروگ</strong> دوباره باز شد.
          نه دیگر کافه، نه دیگر آن میزها و آن جمع. اما اسم ماند.
        </p>
      </section>
