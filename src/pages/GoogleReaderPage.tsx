      ...
      {(() => {
        ...
        return (
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap", margin: "16px 0 0", alignItems: "center" }}>
            ...
            <a href={`https://x.com/intent/tweet?text=${shareText}`} target="_blank" rel="noreferrer" className="ff-btn ff-btn-sm ff-btn-ghost">
              <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.259 5.631 5.905-5.631zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
              در ایکس
            </a>
            <a href={`https://bsky.app/intent/compose?text=${shareText}`} target="_blank" rel="noreferrer" className="ff-btn ff-btn-sm ff-btn-ghost">
              <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor">
